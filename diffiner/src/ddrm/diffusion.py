...
from .backbones.nn import mean_flat
from .backbones.losses import normal_kl, discretized_gaussian_log_likelihood
from ..util.registry import Registry


DiffusionRegistry = Registry("Diffusion")
...
@DiffusionRegistry.register("gaussian")
class GaussianDiffusion:
    ...
    def __init__(
        ...
        self.model_var_type = (
                ModelVarType.FIXED_LARGE if not sigma_small else ModelVarType.LEARNED_RANGE
        )
...
@DiffusionRegistry.register("spaced")
